...
@Controller
public class ReturnSHandler implements CommandHandler{
	...
	public ModelAndView process(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		int s_o_num = Integer.parseInt(request.getParameter("nt"));
		
		orderDao.returnCk(s_o_num);
		...
		return new ModelAndView("order/returnS");
	}
